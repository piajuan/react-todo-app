...
const TodoList = ({itemsList, toggleTodo, deleteTodo, selectedFilter}) => {
    ...
    <div className='bg-light-gray-100 dark:bg-dark-gray-600'>
        <ul>
            {itemsList.map((item) => {
              ...
              return (
                <li onClick={e => toggleTodo(item.id, item.isChecked)} key={item.id} className='group flex justify-between items-center w-full p-4 border-b border-light-gray-200 dark:border-dark-gray-400 border-solid bg-light-gray-100 text-light-gray-500 dark:bg-dark-gray-600 dark:text-dark-gray-100' style={styles}>
